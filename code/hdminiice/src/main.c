...
//volatile uint32_t* colorA = (volatile uint32_t*)0x10000000;
...
int main()
{
    ...
    MYCOLORREGISTER_mWriteReg(XPAR_MYCOLORREGISTER_0_BASEADDR, 0, colorA);
    colorA = colorA + 1024;
    reg2 = MYCOLORREGISTER_mReadReg(XPAR_MYCOLORREGISTER_0_BASEADDR, 8);
    xil_printf("REG 2 : 0x%08X\n\r", reg2);
    xil_printf("COLOR A addr : 0x%08X\n\r", colorA);
    //xil_printf("COLOR A : 0x%08X\n\r", *<colorA);
    sleep(1);
    }
