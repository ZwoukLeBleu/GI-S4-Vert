...
entity fullRamReg_v1_0_M00_AXI is
	generic (
	...
	port (
		...
		i_address : in std_logic_vector(C_M_AXI_ADDR_WIDTH-1 downto 0);
        i_len     : in std_logic_vector(7 downto 0);  -- number of words, max 256
        o_rdata   : out std_logic_vector(C_M_AXI_DATA_WIDTH-1 downto 0);
...
end fullRamReg_v1_0_M00_AXI;

architecture implementation of fullRamReg_v1_0_M00_AXI is
...
begin
	...
	M_AXI_AWADDR	<= std_logic_vector( unsigned(i_address) + unsigned(axi_awaddr) );
	--Burst LENgth is number of transaction beats, minus 1
	M_AXI_AWLEN	<= std_logic_vector(unsigned(i_len)-1 );
	...
	--Read Address (AR)
	M_AXI_ARID	<= (others => '0');
	M_AXI_ARADDR	<= std_logic_vector( unsigned( i_address ) + unsigned( axi_araddr ) );
	--Burst LENgth is number of transaction beats, minus 1
	M_AXI_ARLEN	<= std_logic_vector(unsigned(i_len) );
